const template = {
    keepButton: '<button onclick="keepComment(this)" class="btn keep-btn" style="color:#9DFFCA;"><i class="fa fa-check"></i></button>',
    editButton: '<button onclick="editComment(this)" class="btn edit-btn" style="color:#81B6F6;"><i class="fa fa-pencil"></i></button>',
    deleteButton: '<button onclick="deleteComment(this)" class="btn delete-btn" style="color:#FF9DB1;"><i class="fa fa-close"></i></button>',
    webviewHTML1: ` <!DOCTYPE html>
    <html>
    <head>
